...
<!-- [Company overview](https://www.nextlab.ai/en/sub/company/overview.php),  -->
...
- <span style="color:#7c3aed; font-weight:700;">Links:</span> [Project page](https://github.com/lazybuttrying/afarm_public), [Media coverage 2](https://www.mafra.go.kr/bbs/mafra/68/328591/artclView.do), [Media coverage 2](http://www.wonyesanup.co.kr/news/articleView.html?idxno=50555)
...
- <span style="color:#7c3aed; font-weight:700;">Achievement:</span>    Provincial Government Project, Funded by the Geumsan Country and Applied to Local Farms in Geumsan, Korea
- <span style="color:#7c3aed; font-weight:700;">Summary:</span>
  - Contributed to greenhouse-ready leaf segmentation and leaf-area estimation workflows
  - Calculate the Perilla Leaf Area by Instance Segmentation using MaskRCNN
...
- <span style="color:#7c3aed; font-weight:700;">Affiliation:</span> Seoul National Univerisity
...
- <span style="color:#7c3aed; font-weight:700;">Achievement:</span> Presented as a conference at the Korea Software Congress
- <span style="color:#7c3aed; font-weight:700;">Summary:</span>
